...
# if __name__=="__main__":
    ...
    rating_file_train = os.path.join(os.getcwd(), "UserCF1/data", "rating_train_static.csv")
    rating_file_test = os.path.join(os.getcwd(), "UserCF1/data", "rating_test.csv")
    # rating_file = os.path.join(os.getcwd(), "data", "ratings.dat")
    person2id_file = os.path.join(os.getcwd(), "UserCF1/data", "person2id.csv")
    ...
    # person2place_info = userCF.calculate_score(place)
    # return person2place_info
if __name__=='__main__':
    xietongguolu()
