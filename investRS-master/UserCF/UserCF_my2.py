...
# if __name__=="__main__":
    ...
    rating_file_train = os.path.join(os.getcwd(), "UserCF/data", "rating_train_static.csv")
    rating_file_test = os.path.join(os.getcwd(), "UserCF/data", "rating_test.csv")
    # rating_file = os.path.join(os.getcwd(), "data", "ratings.dat")
    person2id_file = os.path.join(os.getcwd(), "UserCF/data", "person2id.csv")
